return require('packer').startup(function(use)
	...
	use({ "nvim-treesitter/nvim-treesitter-textobjects", 
		after = "nvim-treesitter", requires = "nvim-treesitter/nvim-treesitter", }) --Extended motions

	use { 'williamboman/mason.nvim', 'williamboman/mason-lspconfig.nvim', 'neovim/nvim-lspconfig' } --LSP manager

	use { 'windwp/nvim-autopairs', config = function() require('nvim-autopairs').setup {} end } --pairing "" () [] {} 
	...
	use({ "jackMort/ChatGPT.nvim", config = function() require("chatgpt").setup() end,
		...
		"nvim-telescope/telescope.nvim" } }) --ChatGPT
